module.exports = function(config){
    config.set({
        ...
        files: [
            ...
            'lib/angular-strap-2.0.3/modules/tooltip.js',
            'lib/angular-strap-2.0.3/modules/tooltip.tpl.js',
            'lib/angular-strap-2.0.3/modules/dimensions.js',
            'lib/angular-strap-2.0.3/modules/parse-options.js',
            'lib/angular-strap-2.0.3/modules/date-parser.js',
            'lib/angular-strap-2.0.3/modules/datepicker.js',
            'lib/angular-strap-2.0.3/modules/datepicker.tpl.js',
            'lib/angular-strap-2.0.3/modules/timepicker.js',
            'lib/angular-strap-2.0.3/modules/timepicker.tpl.js',
            'lib/angular-strap-2.0.3/modules/typeahead.js',
            'lib/angular-strap-2.0.3/modules/typeahead.tpl.js',
